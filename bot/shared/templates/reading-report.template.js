...
function renderHeader(data, logoB64) {
  ...
  const subtitle = data.comprehension
    ? 'Student Reading Fluency &amp; Comprehension Evaluation powered by NIETE'
    : 'Student Reading Fluency Evaluation powered by NIETE';
  return `
<div class="header">
...
function renderFooter(data) {
  const reportDate = fmtDate(data.completedAt);
  return `<div class="footer">Generated by NIETE • Supporting teachers everywhere • ${reportDate}</div>`;
}
